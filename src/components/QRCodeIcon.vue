<template>
  <div class="placeholder">
    <div class="placeholder__corner placeholder__corner_top-left"></div>
    <div class="placeholder__corner placeholder__corner_top-right"></div>
    <div class="placeholder__corner placeholder__corner_bottom-right"></div>
    <div class="placeholder__corner placeholder__corner_bottom-left"></div>
    <svg
